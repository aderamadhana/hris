...
<style scoped>
/* kamu bisa pakai style form dari file sebelumnya (yang sudah kamu punya).
   Kalau file detail-page lama punya style .field dll, boleh dibiarkan,
   tapi sekarang mayoritas pakai .form-* */
...
/* biar timeline/list yang lama tetap rapi */
.education-list,
.family-list {
    display: flex;
    flex-direction: column;
