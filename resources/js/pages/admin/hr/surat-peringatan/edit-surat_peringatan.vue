<template>
    <Modal size="lg">
        ...
        <p class="modal-text">
            Edit atau hapus surat peringatan sesuai data yang benar
        </p>
        ...
        <div class="modal-body">
            <div class="detail-grid two-col">
                ...
                <div class="form-group" style="grid-column: 1 / -1">
                    ...
                    <div
                        v-if="surat_peringatan?.file_url"
                    ...
                    >
                        ...
                        <span class="text-muted">
                            ({{ surat_peringatan.file_path || 'file' }})
                        </span>
                    </div>
...
export default {
    ...
    data() {
        return {
            ...
            form: {
                ...
                tingkat: this.surat_peringatan?.tingkat ?? 'SP1',
    ...
    methods: {
            ...
            router.post(
                ...
                },
                {
                    ...
                    onSuccess: () => {
                        triggerAlert(
                            'success',
                            'Surat peringatan berhasil diupdate',
                        );
        ...
        deleteSP() {
            if (
                !confirm(
                    'Apakah Anda yakin ingin menghapus surat peringatan ini?',
                )
            )
                return;
            ...
            router.delete(
                `/hr/surat-peringatan/delete/${this.surat_peringatan.id}`,
                {
                    onSuccess: () => {
                        triggerAlert(
                            'success',
                    ...
                    onError: () => {
                        triggerAlert(
                            'error',
                            'Gagal menghapus surat peringatan',
                        );
                    },
