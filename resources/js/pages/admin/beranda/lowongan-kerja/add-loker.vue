<template>
    <Modal size="lg">
        ...
        <p class="modal-text">Tambah loker sesuai data yang benar</p>
            ...
            <div class="detail-grid two-col">
                ...
                <div class="form-group" style="grid-column: 1 / -1">
                    ...
                    <input
                        ...
                        class="form-input"
                        placeholder="Contoh: Penempatan Jabodetabek, sistem shift..."
                    />
...
export default {
    ...
    methods: {
        ...
        async submitLoker() {
            ...
            router.post('/beranda/lowongan-kerja/store', this.form, {
                onSuccess: () => {
                    triggerAlert('success', 'Loker berhasil disimpan');
